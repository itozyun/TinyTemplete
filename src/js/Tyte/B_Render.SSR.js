...
var EMPTY_ELEMENTS   = {link:!0,meta:!0,br:!0,hr:!0,img:!0,input:!0,area:!0,base:!0,col:!0,embed:!0,keygen:!0,param:!0,source:!0},
    ...
    IS_XML_ELEMENT   = !DEFINE_TYTE__USE_VML ? {polyline:!0,rect:!0,line:!0,path:!0} : {polyline:!0,rect:!0,line:!0,path:!0,'v:polyline':!0,'v:rect':!0,'v:line':!0},
...
if( DEFINE_TYTE__USE_RENDER_SSR ){
    ...
    TyteElementBase.prototype.renderSSR = function( renderingParam ){
        ...
        if( this._childNodes ){
            htmlString[ ++i ] = '>';
            htmlString[ ++i ] = childNodesString = TyteDocumentFragment_renderSSR.call( this, renderingParam );
        } else {
